  ...
  const four = (
    <>
      <p>
        ...
        jamoasining maqsadlari: Azim yo‘llarda qalblari xasta ko‘ngil egalariga dilkash bo‘lish!
        Zinama-zina ko‘tarilar ekanmiz, Yagona Allohni suyanch bilib, qalbingiz sakinat, bolalarcha
        beg‘ubor kulgi ila to‘lishida o‘z hissamizni qo‘shish! .
      </p>
    </>
  );
  const five = (
